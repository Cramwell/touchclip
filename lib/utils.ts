...
const MARKUP_RATES = {
  Phones: [
    ...
    { min: 150, max: 199.99, rate: 0.3 },
    { min: 200, max: 499.99, rate: 0.25 },
    { min: 500, max: 999.99, rate: 0.2 },
    { min: 1000, max: 1999.99, rate: 0.17 },
    { min: 2000, max: 3999.99, rate: 0.15 },
    { min: 4000, max: 5000, rate: 0.12 },
    { min: 5001, max: Infinity, rate: 0.1 },
  ],
  Laptops: [
    { min: 0, max: 49.99, rate: 1.0 },
    { min: 50, max: 99.99, rate: 0.75 },
    { min: 100, max: 149.99, rate: 0.5 },
    { min: 150, max: 199.99, rate: 0.35 },
    { min: 200, max: 499.99, rate: 0.26 },
    { min: 500, max: 999.99, rate: 0.23 },
    { min: 1000, max: 1999.99, rate: 0.2 },
    { min: 2000, max: 3999.99, rate: 0.18 },
    { min: 4000, max: 5000, rate: 0.16 },
    { min: 5001, max: Infinity, rate: 0.13 },
  ],
  ...
  General: [
    ...
    { min: 150, max: 199.99, rate: 0.25 },
    { min: 200, max: 499.99, rate: 0.2 },
    { min: 500, max: 999.99, rate: 0.18 },
